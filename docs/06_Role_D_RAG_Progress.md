...
| 内容 | 代码现状 |
|---|---|
| 种子 | data/history_records.json，共1000条，购物500、时间500（购物覆盖电子数码/学习办公/生活家电/服饰/运动户外/食品/图书/美妆个护/游戏/收纳/出行及日用品相关品类：清洁用品/纸品耗材/厨房用品/个护清洁/家纺布艺/防护日用/文具耗材）；由 `rag/build_history_data.py` 幂等生成 |
